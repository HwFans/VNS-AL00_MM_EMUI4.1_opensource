...
#define MODULE_MANUFACTURE_NUMBER		4
...
static struct apds9251_tp_lx_cal_parameter apds9251_tp_module_parameter[MODULE_MANUFACTURE_NUMBER] = {{.tp_module_id = 0x55},{.tp_module_id = 0x55},{.tp_module_id = 0x55},{.tp_module_id = 0x55}};
